...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('buku.create') }}"><button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i>
                    Tambah</button></a>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($buku as $data)
                        <tr>
                            <td>{{ $data->nama }}</td>
                            <td><img src="{{ Storage::url('buku/' . $data->foto) }}" style="width:150px"
                                    class="img-thumbnail">
                            ...
                            <td>
                                ...
                                <a href="{{ route('buku.edit', $data->id) }}" class="btn btn-outline-warning">
